                    ...
                    <div className="flex items-center gap-6 flex-1">
                      <Avatar className="h-32 w-32 border-4 border-[#F8B90C]/20">
                        <AvatarImage
                          ...
                          alt={proData.name}
                        />
                        <AvatarFallback className="text-3xl bg-gradient-to-br from-[#F8B90C] to-[#FFCF53] text-[#000000]">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 text-gray-600 mb-2">
                          ...
                          <span className="text-base">
                            Serves {proData.location}
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-600">
                          <CheckCircle2 className="w-5 h-5 text-[#F8B90C]" />
                          <span className="text-base">
                            Hired {proData.hiredCount} times
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              <Card>
                <CardContent className="p-8">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <a
                      href="#"
                      className="text-sm text-[#0032FF] hover:underline font-medium"
                    >
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center justify-center gap-2 pb-4 border-bottom border-gray-100">
                        {(() => {
                          ...
                          const sum =
                            5 * breakdown[5 as keyof typeof breakdown] +
                            4 * breakdown[4 as keyof typeof breakdown] +
                            3 * breakdown[3 as keyof typeof breakdown] +
                            2 * breakdown[2 as keyof typeof breakdown] +
                            1 * breakdown[1 as keyof typeof breakdown];
                            ...
                            <>
                              <div className="flex items-center gap-1">
                                {Array.from({ length: 5 }).map((_, i) => (
                                  <StarIcon
                                    key={i}
                                    className={`w-5 h-5 ${i < filled ? "text-[#F8B90C] fill-[#F8B90C]" : "text-gray-300"}`}
                                  />
                                ))}
                              </div>
